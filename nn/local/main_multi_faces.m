...
REQ_PATHS.VAL_IMG_PATH = ['./cachedir/faces-edges-val/'];
REQ_PATHS.TRAIN_DATA_PATH = ['./cachedir/', CACHENAME, '/feats/train/'];
REQ_PATHS.TRAIN_IMG_ORG_PATH = ['./cachedir/faces-edges/train/'];
REQ_PATHS.TRAIN_IMG_PATH = ['./cachedir/faces-edges/train/'];
REQ_PATHS.CACHE_DIR = ['./cachedir/', CACHENAME,'/nns_conv5/'];
REQ_PATHS.DUMP_DATA_PATH = ['./cachedir/', CACHENAME, '/hi-res-multi/'];
...
generate_multi_outputs(REQ_PATHS, GPU)
